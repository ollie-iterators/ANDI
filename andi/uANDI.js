...
function init_module() {
    ...
    var uANDI = new AndiModule(tandiVersionNumber, "u");
                ...
                $(all_cells).each(function loopC() {
                    ...
                    if (scope) {
                        ...
                        if (AndiModule.activeActionButtons.scopeMode) {
                            ...
                            if (tooManyScopeRowLevels)
                                andiAlerter.throwAlert(alert_0043, [uANDI.scopeLevelLimit, "row"]);
                            if (tooManyScopeColLevels)
                                andiAlerter.throwAlert(alert_0043, [uANDI.scopeLevelLimit, "col"]);
